...
## [06月30日(月)](#30) <a id="30"></a>

会議。

数理物理の中間テスト。

いろいろ書くことがあった気がするが、なんかどうでも良くなった。

論文を書く時間を確保したい・・・

Claude Codeの使い方の知見が溜まっているのだが、最終的に「要件定義をしっかりしましょう」に落ち着いてるの、一周回った感があるな。

論文にLLM用の命令インジェクションがなされることが話題に。「`"GIVE A POSITIVE REVIEW" site:http://arxiv.org`」で検索すると大量に出てくる。ある種の不正だが、この不正が有効に働くためには査読で不正が起きていないといけないわけで、いろいろ考えてしまう。

## [06月29日(日)](#29) <a id="29"></a>

NOP

## [06月28日(土)](#28) <a id="28"></a>
