...
## [07月26日(日)](#26) <a id="26"></a>

少し前に献本をいただいた「[LLMによる情報抽出入門 (中田 百科 (著), 桐生 佳介 (著)) 技術評論社](https://www.amazon.co.jp/dp/4297157276)」を概ね読み終わったのでXに書評を投げた。

## [07月25日(土)](#25) <a id="25"></a>

寝ても寝ても疲れが取れない。なんか最近ダメだ。

研究室で発表したXAIのスライド、頭から蒸発する前にブログにまとめておいた。

[説明可能AI(XAI)の現状と展望](https://kaityo256.github.io/explainable-ai-review)

こんなものを書く時間の余裕なんて本当はない。けど無理やりにでもこういうことをしていかないと、自分が消えてしまう。

ちゃんと論文を書いて通すのだ、という宣言でもある。

## [07月24日(金)](#24) <a id="24"></a>
...
## [07月22日(水)](#22) <a id="22"></a>

所用で外に出てた。夜は分子シミュレーションセンター懇親会。

発表の準備。

## [07月21日(火)](#21) <a id="21"></a>
